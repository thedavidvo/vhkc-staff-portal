                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap gap-2 justify-center flex-1 min-w-0">
                        {driver.roundPoints.map((round: { roundId: string; roundNumber: number; roundName: string; location: string; points: number }) => (
                          <div
                            key={round.roundId}
                            className="bg-slate-50 dark:bg-slate-800 rounded-md border border-slate-200 dark:border-slate-800 p-2 w-[100px] flex-shrink-0"
                          >
                        ...
                        {driver.dropRound && (
                          <div className="bg-red-50 dark:bg-red-900/20 rounded-md border border-red-200 dark:border-red-800 p-2 w-[100px] flex-shrink-0">
